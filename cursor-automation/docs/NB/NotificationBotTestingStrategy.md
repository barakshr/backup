# Notification Bot -- Testing Strategy

> **Service under test:** Notification Bot (NB)
> **Scope:** Component / Service-level tests
> **Approach:** Test NB in isolation. Mock downstream dependency (Microsoft Graph API) with WireMock.
> **Priority for this round:** A1, B1

---

## NB API Contract (Designed for Practice)
...
```json
{
  ...
  "internalParticipants": [
    { "userId": "uuid", "displayName": "Alice Smith" }
  ],
  "detectedPerson": {
    "personId": "uuid",
